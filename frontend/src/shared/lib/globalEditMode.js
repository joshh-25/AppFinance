...
export function clearGlobalEditMode() {
  ...
  // Clear legacy in-memory bridge used by Records -> Bills edit handoff.
  if (Object.prototype.hasOwnProperty.call(window, '__finance_records_edit_context')) {
    delete window.__finance_records_edit_context;
  }
