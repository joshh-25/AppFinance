...
export function SkeletonButton({ className = '', width = 140, height = 44, radius = 12 }) {
  return <SkeletonBlock className={`skeleton-button ${className}`.trim()} width={width} height={height} radius={radius} />;
}
